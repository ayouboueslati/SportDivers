...
class MatchListPage extends StatelessWidget {
  static String id = 'Match_List_Page';
  final Tournament tournament;

  const MatchListPage({Key? key, required this.tournament}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MatchListProvider()..fetchMatches(tournament.id),
      child: Scaffold(
        appBar: AppBar(
          leading: Padding(
  ...
  String _formatTime(DateTime date) {
    // You can use intl package for better time formatting
